namespace AniDroidv2.AniList.Enums.ActivityEnums
{
    public sealed class NotificationType : AniListEnum
    {
        ...
        public static NotificationType MediaDataChange { get; } = new NotificationType("MEDIA_DATA_CHANGE", "Media Data Change", 14);
        public static NotificationType MediaMerge { get; } = new NotificationType("MEDIA_MERGE", "Media Merge", 15);
        public static NotificationType MediaDeletion { get; } = new NotificationType("MEDIA_DELETION", "Media Deletion", 16);
    }
}
